...
class Note extends React.Component {
    ...
    render() {
        return (
            // <div id={"Note" + this.props.NoteNumberTracker} className="Note">
            //     <p id="NoteDescription">{this.props.NoteDescription}</p>
            //     <button id="EditButton" onClick={this.editNote}>Edit</button>
